                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="container-fluid">
                                                        <form action="vaksin_klinik/proses_update" class="form-control"
                                                            method="POST" enctype="multipart/form-data">
                                                            <div class="form-group row mb-2">
                                                                <label for="" class="col-sm-3 col-form-label">Nama
                                                                    Lengkap</label>
                                                                <div class="col-sm-9">
                                                                    <input type="text" value="<?= $update->nama; ?>"
                                                            ...
                                                            <div class="form-group row mb-2">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="number" value="<?= $update->umur; ?>"
                                                                        autocomplete="off" name="umur"
                                                            ...
                                                            <div class="form-group row mb-2">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" autocomplete="off"
                                                                        value="<?= $update->no_telp; ?>" name="no_telp"
                                                            ...
                                                            <div class="form-group row mb-2">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <select class="form-control" name="jk">
                                                                        <option
                                                                            <?= ($update->jenis_kelamin == "") ? "selected" : ""; ?>
                                                                            selected>- Jenis
                                                                            Kelamin -</option>
                                                                        <option
                                                                            <?= ($update->jenis_kelamin == "Laki-Laki") ? "selected" : ""; ?>
                                                                            value="Laki-Laki">Laki-Laki</option>
                                                                        <option
                                                                            <?= ($update->jenis_kelamin == "Perempuan") ? "selected" : ""; ?>
                                                            ...
                                                            <div class="form-group row mb-2">
                                                                <label for="" class="col-sm-3 col-form-label">Alamat
                                                                    Sekarang</label>
                                                                <div class="col-sm-9">
                                                                    <input type="text" value="<?= $update->alamat; ?>"
                                                            ...
                                                            <div class="form-group row mb-2">
                                                                <div class="d-grid gap-2 col-6 mx-auto">
                                                                    <button class="btn btn-success" name="daftar">Ubah
                                                                        Data</button>
                                                                </div>
                                                            </div>
                                                        </form>
