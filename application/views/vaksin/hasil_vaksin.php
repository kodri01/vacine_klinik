                                    ...
                                    <div class="container-fluid">
                                            ...
                                            <ol class="breadcrumb">
                                                <ol class="breadcrumb">
                                                    <li class="breadcrumb-item"><a
                                                            href="vaksin_klinik/vaksinasi">Vaksinasi</a></li>
                                        ...
                                        <div class="card shadow mb-4">
                                            <div class="card-header py-3">
                                                <h6 class="m-0 font-weight-bold ">Hasil Vaksin</h6>
                                            </div>
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    ...
                                                    <table class="table table-bordered" id="dataTable" cellspacing="1">
                                                        <thead>
                                                            <tr>
                                                                <th class="text-center" width="9%">No Tiket</th>
                                                                <th class="text-center" width="10%">Nama Lengkap
                                                                </th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="text-uppercase"><?= $v->no_tiket ?></td>
                                                                <td><?= $v->nama ?></td>
                                                                <td><?= $v->no_nik ?></td>
                                                                <td><?= $v->no_telp ?></td>
                                                                ...
                                                                <td><?= $v->vaksin_ket ?></td>
                                                                <td align="center">
                                                                    <a href="<?php echo site_url('vaksin_klinik/cetak_vaksin/' . $v->no_nik); ?>"
